...
const MapComponents = dynamic(
  () => import('@/app/dashboard/components/MapComponents'),
  { 
    loading: () => (
...
interface ClevelandTechMapProps {
...
export default function ClevelandTechMap({ organizations }: ClevelandTechMapProps) {
          ...
          {Object.entries({
            ...
            <div 
              ...
              className={`flex items-center px-1 py-0.5 rounded cursor-pointer transition-colors ${
                selectedIndustry === industry ? 'bg-blue-100 font-medium' : 'hover:bg-gray-50'
              }`}
